...
#Load CSVs
all_files = glob.glob("receiving*.csv")
...
cursor.execute("TRUNCATE TABLE FANTASY_FOOTBALL.receiving")
...
for i,row in df.iterrows():
    ...
    if len(row[0]) <= 4:
        continue
    sql = "INSERT INTO FANTASY_FOOTBALL.receiving VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
